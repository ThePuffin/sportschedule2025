export const ColorsTeamEnum: Record<string, { color: string; backgroundColor: string }> = {
  ...
  'PWHL-NY': {
    color: '#00b9b3',
    backgroundColor: '#011e42',
  },
  'PWHL-OTT': {
    color: '#fdb81e',
    backgroundColor: '#a51b2f',
  },
  'PWHL-SEA': {
    color: '#E1DBC9',
